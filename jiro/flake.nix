{
  ...
  outputs = { self, nixpkgs, nixos-hardware, home-manager, nur, niri-flake, stylix, wezterm-flake, xremap-flake, ... }@inputs: {
      ...
      modules = [
        ...
        home-manager.nixosModules.home-manager
        {
          home-manager = {
            ...
            # extraSpecialArgs = inputs // { username = "yysushi"; niri-flake = niri-flake; };
